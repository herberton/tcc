...
public class EcommerceUserRegistrationBusiness 
	extends DefaultUserRegistrationBusiness<EcommerceUserDTO>
	implements IEcommerceUserRegistrationBusiness {
	...
	public List<EcommerceUserDTO> list() {
